                           ...
                           System.out.println("Cat id="+request.getParameter("catid"));
                            ...
                            <div class="col-lg-4 col-md-6 mb-4">
                                <div class="card h-100">
                                    <a href="#"><img class="card-img-top" src="<%=news.getImage()%>" alt="Not available"></a>
                                    <div class="card-body">
                                        <h4 class="card-title">
                                            <a href="#"><%=news.getTitle()%></a>
                                        </h4>
                                       
                                            <p class="card-text"><% if(news.getDescription().trim().length()>100)out.println(news.getDescription().trim().substring(0,99)+".."); else 
                                                 out.println(news.getDescription().trim()); %></p>
                                    </div>
