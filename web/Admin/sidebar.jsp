      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="viewPending.jsp">View Pending News</a>
       ...
       <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="viewAllReporters.jsp">View All Reporters</a>
            <a class="collapse-item" href="viewPendingReporters.jsp">View Pending Reporters</a>
         </div>
        </div>
      </li>
      <!-- Divider -->
